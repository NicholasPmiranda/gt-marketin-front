...
### Configuracoes de Credenciais (`config-credenciais.md`)
- **Credenciais (Config)** - CRUD de credenciais com senha criptografada, controle de visualizacao por liberacao e fluxo de solicitacao de edicao para aprovacao de admin.
